    ...
    <div ref={contentRef} className="min-h-screen bg-gray-50">
      ...
      <section className="relative h-60 md:h-72 lg:h-80 overflow-hidden">
        <div className="absolute inset-0 w-full h-full">
          <div className="absolute inset-0 bg-[url('/images/products/productshero.jpg')] bg-cover bg-center z-0">
            <div className="absolute inset-0 bg-gradient-to-r from-nyati-orange via-nyati-orange/85 to-nyati-orange/25 z-10"></div>
          </div>
        </div>
